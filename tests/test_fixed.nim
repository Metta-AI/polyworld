...
echo "Testing fixed layout, whole parts, and fractions"
block:
...
echo "Testing fixed literals and text"
block:
...
echo "Testing fixed addition, subtraction, and comparison"
block:
...
echo "Testing fixed multiplication and division"
block:
...
echo "Testing integer square roots against the textbook algorithm"
block:
...
echo "Testing fixed square roots and lengths"
block:
...
echo "Testing fixed two-dimensional vectors"
block:
  let
...
echo "Testing fixed trigonometry"
block:
...
echo "Testing fixed accuracy against a reference"
block:
  var
    worstSine = 0.0
    worstCosine = 0.0
...
echo "Testing fixed table stability"
block:
...
echo "Testing fixed determinism"
block:
